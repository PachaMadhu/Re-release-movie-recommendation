...
With the growing trend of movie re-releases in India, this project aims to answer two practical questions:
...
🔹 Model 1: Interest Prediction (Classification)
...
Age
Ticket price
Theatre visit frequency
Favourite actor
Interest type (nostalgia, actor, story, etc.)

🔹 Model 2: Movie Recommendation System
